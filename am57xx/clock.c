...
struct clock *clock_init() {
	...
	*((uint32_t *) 0x6a005520) |= BIT(24);
	...
	/* TODO IPU2 */
	*((uint32_t *) 0x6A005504) |= STATICDEP_L4PER3 | STATICDEP_L4PER2 | STATICDEP_IPU | STATICDEP_COREAON | STATICDEP_WKUPAON | STATICDEP_L4SEC | STATICDEP_L4PER | STATICDEP_L4CFG | STATICDEP_SDMA | STATICDEP_L3INIT | STATICDEP_L3MAIN1 | STATICDEP_EMIF;
	return &clock;
}
