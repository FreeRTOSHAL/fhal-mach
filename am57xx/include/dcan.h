...
#define DCAN_ERRC_RP_MASK						0x00008000ul
#define DCAN_ERRC_REC_MASK						0x00007F00ul
#define DCAN_ERRC_REC_SHIFT						8u
#define DCAN_ERRC_REC_WIDTH						7u
#define DCAN_ERRC_REC(x)						(((uint32_t)(((uint32_t)(x))<<DCAN_ERRC_REC_SHIFT))&DCAN_ERRC_REC_MASK)
#define DCAN_ERRC_TEC_MASK						0x000000FFul
#define DCAN_ERRC_TEC_SHIFT						0u
#define DCAN_ERRC_TEC_WIDTH						8u
#define DCAN_ERRC_TEC(x)						(((uint32_t)(((uint32_t)(x))<<DCAN_ERRC_TEC_SHIFT))&DCAN_ERRC_TEC_MASK)
...
#define DCAN_ERROR_WARNING_LIMIT				96u
