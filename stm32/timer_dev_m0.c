...
struct timer stm32_tim15 = {
	TIMER_INIT_DEV(stm32)
	HAL_NAME("Timer 15")
	.base = TIM15,
	.clock = RCC_APBPeriph_TIM15,
	.RCC_APBxPeriphClockCmd = RCC_APBPeriphClockCmd,
	.irqNr = TIM15_IRQn,
	.maxCounter = UINT16_MAX,
};
TIMER_ADDDEV(stm32, stm32_tim15);
void tim15_irqn(void) {
	stm32_timer_interruptHandler(&stm32_tim15);
}
#endif
#ifdef CONFIG_STM32_TIM16
struct timer stm32_tim16 = {
	TIMER_INIT_DEV(stm32)
	HAL_NAME("Timer 16")
	.base = TIM16,
	.clock = RCC_APBPeriph_TIM16,
	.RCC_APBxPeriphClockCmd = RCC_APBPeriphClockCmd,
	.irqNr = TIM16_IRQn,
	.maxCounter = UINT16_MAX,
};
TIMER_ADDDEV(stm32, stm32_tim16);
void tim16_irqn(void) {
	stm32_timer_interruptHandler(&stm32_tim16);
}
#endif
#ifdef CONFIG_STM32_TIM17
struct timer stm32_tim17 = {
	TIMER_INIT_DEV(stm32)
	HAL_NAME("Timer 17")
	.base = TIM17,
	.clock = RCC_APBPeriph_TIM17,
	.RCC_APBxPeriphClockCmd = RCC_APBPeriphClockCmd,
	.irqNr = TIM17_IRQn,
	.maxCounter = UINT16_MAX,
};
TIMER_ADDDEV(stm32, stm32_tim17);
void tim17_irqn(void) {
	stm32_timer_interruptHandler(&stm32_tim17);
}
#endif
