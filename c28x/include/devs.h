...
# define EPWM1_TIMER_ID HAL_GET_ID(pwm, epwm, epwm1_data)
#endif
...
# define EPWM2_TIMER_ID HAL_GET_ID(pwm, epwm, epwm2_data)
#endif
...
# define EPWM3_TIMER_ID HAL_GET_ID(pwm, epwm, epwm3_data)
#endif
...
# define EPWM4_TIMER_ID HAL_GET_ID(pwm, epwm, epwm4_data)
#endif
...
# define EPWM5_TIMER_ID HAL_GET_ID(pwm, epwm, epwm5_data)
#endif
...
# define EPWM6_TIMER_ID HAL_GET_ID(pwm, epwm, epwm6_data)
#endif
...
# define EPWM7_TIMER_ID HAL_GET_ID(pwm, epwm, epwm7_data)
#endif
...
# define EPWM8_TIMER_ID HAL_GET_ID(pwm, epwm, epwm8_data)
#endif
