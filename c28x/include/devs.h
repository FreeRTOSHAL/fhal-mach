...
# define EPWM3_TIMER_ID HAL_GET_ID(pwm, timer, epwm3_data)
#endif
...
# define EPWM4_TIMER_ID HAL_GET_ID(pwm, timer, epwm4_data)
#endif
...
# define EPWM5_TIMER_ID HAL_GET_ID(pwm, timer, epwm5_data)
#endif
...
# define EPWM6_TIMER_ID HAL_GET_ID(pwm, timer, epwm6_data)
#endif
...
# define EPWM7_TIMER_ID HAL_GET_ID(pwm, timer, epwm7_data)
#endif
...
# define EPWM8_TIMER_ID HAL_GET_ID(pwm, timer, epwm8_data)
#endif
