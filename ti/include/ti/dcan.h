...
#define DCAN_CTL_SWR_MASK             0x00008000u
...
#define DCAN_IF1CMD_MESSAGE_NUMBER_MASK       0x000000FFu
...
#define DCAN_IF1CMD_DMAACTIVE_MASK            0x00004000u
...
#define DCAN_IF1CMD_BUSY_MASK                 0x00008000u
...
#define DCAN_IF1CMD_DATA_B_MASK               0x00010000u
...
#define DCAN_IF1CMD_DATA_A_MASK               0x00020000u
...
#define DCAN_IF1CMD_TXRQST_NEWDAT_MASK        0x00040000u
...
#define DCAN_IF1CMD_CLRINTPND_MASK            0x00080000u
...
#define DCAN_IF1CMD_CONTROL_MASK              0x00100000u
...
#define DCAN_IF1CMD_ARB_MASK                  0x00200000u
...
#define DCAN_IF1CMD_WR_RD_MASK                0x00800000u
...
#define DCAN_IF1MSK_MXTD_MASK                 0x80000000u
#define DCAN_IF1MSK_MDIR_MASK                 0x40000000u
#define DCAN_IF1MSK_MSK_MASK                  0x1FFFFFFFu
...
#define DCAN_IF1ARB_MSGVAL_MASK               0x80000000u
#define DCAN_IF1ARB_XTD_MASK                  0x40000000u
#define DCAN_IF1ARB_DIR_MASK                  0x20000000u
#define DCAN_IF1ARB_ID_EXT_MASK               0x1FFFFFFFu
...
#define DCAN_IF1ARB_ID_STD_MASK               0x1FFC0000u
...
#define DCAN_IF1MCTL_DLC_MASK                 0x0000000Fu
...
#define DCAN_IF1MCTL_EOB_MASK                 0x00000080u
#define DCAN_IF1MCTL_TXRQST_MASK              0x00000100u
#define DCAN_IF1MCTL_RMTEN_MASK               0x00000200u
#define DCAN_IF1MCTL_RXIE_MASK                0x00000400u
#define DCAN_IF1MCTL_TXIE_MASK                0x00000800u
#define DCAN_IF1MCTL_UMASK_MASK               0x00001000u
#define DCAN_IF1MCTL_INTPND_MASK              0x00002000u
#define DCAN_IF1MCTL_MSGLST_MASK              0x00004000u
#define DCAN_IF1MCTL_NEWDAT_MASK              0x00008000u


#define DCAN_IF2CMD_MESSAGE_NUMBER_MASK       0x000000FFu
...
#define DCAN_IF2CMD_DMAACTIVE_MASK            0x00004000u
...
#define DCAN_IF2CMD_BUSY_MASK                 0x00008000u
...
#define DCAN_IF2CMD_DATA_B_MASK               0x00010000u
...
#define DCAN_IF2CMD_DATA_A_MASK               0x00020000u
...
#define DCAN_IF2CMD_TXRQST_NEWDAT_MASK        0x00040000u
...
#define DCAN_IF2CMD_CLRINTPND_MASK            0x00080000u
...
#define DCAN_IF2CMD_CONTROL_MASK              0x00100000u
...
#define DCAN_IF2CMD_ARB_MASK                  0x00200000u
...
#define DCAN_IF2CMD_MASK_MASK                 0x00400000u
...
#define DCAN_IF2CMD_WR_RD_MASK                0x00800000u
...
#define DCAN_IF2MSK_MXTD_MASK                 0x80000000u
#define DCAN_IF2MSK_MDIR_MASK                 0x40000000u
#define DCAN_IF2MSK_MSK_MASK                  0x1FFFFFFFu
...
#define DCAN_IF2ARB_MSGVAL_MASK               0x80000000u
#define DCAN_IF2ARB_XTD_MASK                  0x40000000u
#define DCAN_IF2ARB_DIR_MASK                  0x20000000u
#define DCAN_IF2ARB_ID_EXT_MASK               0x1FFFFFFFu
...
#define DCAN_IF2ARB_ID_STD_MASK               0x1FFC0000u
...
#define DCAN_IF2MCTL_DLC_MASK                 0x0000000Fu
...
#define DCAN_IF2MCTL_EOB_MASK                 0x00000080u
#define DCAN_IF2MCTL_TXRQST_MASK              0x00000100u
#define DCAN_IF2MCTL_RMTEN_MASK               0x00000200u
#define DCAN_IF2MCTL_RXIE_MASK                0x00000400u
#define DCAN_IF2MCTL_TXIE_MASK                0x00000800u
#define DCAN_IF2MCTL_UMASK_MASK               0x00001000u
#define DCAN_IF2MCTL_INTPND_MASK              0x00002000u
#define DCAN_IF2MCTL_MSGLST_MASK              0x00004000u
#define DCAN_IF2MCTL_NEWDAT_MASK              0x00008000u
